...
请在云厂商云服务器管理控制台的安全组中开放以下所有端口！

![开放所需端口](images/safety%20group.jpg)
...
| **Spark Master**      | 查看Spark集群状态（Standalone模式）        | 8080     | `http://<Spark主节点IP>:8080`     |
| **Spark Worker**      | 查看Spark工作节点状态（Standalone模式）    | 8081     | `http://<Spark从节点IP>:8081`     |
